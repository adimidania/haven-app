...
const quotes = [
    ...
    { "id": 21, "quote": "Respond to every call that excites your spirit.", "author": "Rumi" },
    { "id": 22, "quote": "The Way To Get Started Is To Quit Talking And Begin Doing.", "author": "Walt Disney" },
    { "id": 23, "quote": "God Doesn'T Require Us To Succeed, He Only Requires That You Try.", "author": "Mother Teresa" },
    { "id": 24, "quote": "Speak any language, Turkish, Greek, Persian, Arabic, but always speak with love.", "author": "Rumi" },
    { "id": 25, "quote": "Happiness comes towards those which believe in him.", "author": "Ali ibn Abi Talib (R.A)" },
    { "id": 26, "quote": "Knowledge is of two kinds: that which is absorbed and that which is heard. And that which is heard does not profit if it is not absorbed.", "author": "Ali ibn Abi Talib (R.A)" },
    { "id": 27, "quote": "When I am silent, I have thunder hidden inside.", "author": "Rumi" },
    { "id": 28, "quote": "Technological Progress Is Like An Axe In The Hands Of A Pathological Criminal.", "author": "Albert Einstein" },
    { "id": 29, "quote": "No One Would Choose A Friendless Existence On Condition Of Having All The Other Things In The World.", "author": "Aristotle" },
    { "id": 30, "quote": "Life is a gamble. You can get hurt, but people die in plane crashes, lose their arms and legs in car accidents; people die every day. Same with fighters: some die, some get hurt, some go on. You just don't let yourself believe it will happen to you.", "author": "Muhammad Ali" }
]
                ...
                <div className="flex-1 space-y-4 p-4 pt-6 md:p-8 w-1/2">
                    <div className="flex items-center">
                        <div className="flex flex-col w-1/2">
                            ...
                            <Link href={'/my-tracker'}>
                                <Button className="text-accent w-fit mt-8">
                                    Update My Tracker
                                </Button>
                            </Link>
                        </div>
